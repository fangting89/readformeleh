...
readformeleh ("read for me, leh" - "leh" is a soft, casual Singlish
sentence-particle used to ask for a small favour) is a WhatsApp-native
...
who it's from, what it says, what to do, by when, in English, Mandarin,
Malay, or Tamil.
